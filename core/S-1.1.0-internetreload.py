...
class TimedClicker():
    ...
    def findSite(self, site_):
        ...
        try:
            ...
            print("Offline. 30s before reloading again")
            hasfailed = 1
        ...
        try:
            ...
            print("Offline. 60s before reloading again")
            hasfailed = 2
        ...
        try:
            ...
            print("Offline. 5 minutes before reloading again")
            hasfailed = 3  
        ...
        try:
            ...
            print("Page failed to load. Offline.") ###########-------------< continue error here
