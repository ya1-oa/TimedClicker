...
class TimedClicker():
    ...
    def wait_click_x(self, xpath_, button):
        try:
            wait = WebDriverWait(self.driver, 450)
    ...
    def wait_Lst(self):
        ...
        try:
            ...
            log.set("Timed out finding List, restart")
            pass
    ...
    def sLogic(self):
        def secretariat_brain():
            ...
            if W_over5 == True and T_over0 == False and self.stop == False:
                ...
                while True and self.stop == False:
                    wait = WebDriverWait(self.driver, 450, poll_frequency=5)
                    try:
...
class Secretariat():
    ...
    def run(self):
        ...
        self.start_btn = ttk.Button(self.root, text="Start", style="Accent.TButton", command=self.change_button)
